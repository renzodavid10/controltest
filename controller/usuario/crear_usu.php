...
$usu_rol =  htmlspecialchars($_POST['rol'], ENT_QUOTES, 'UTF-8');
$usu_foto='';
$consultar = $MU->create_user($usu_name,$usu_apap,$usu_apam,$usu_dni,$usu_celu,$usu_corr,$usu_pass,$usu_foto,$usu_empr,$usu_rol);
echo $consultar;
